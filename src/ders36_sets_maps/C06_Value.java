...
public class C06_Value {
    public static void main(String[] args) {
        ...
        // mapOlustur method' bize bir map donduruyor
        ...
        // [Ali-Can-11-H-Mf, Veli-Cem-10-K-TM, Ali-Cem-11-K-TM, Ayse-Can-10-H-MF, Sevgi-Cem-11-K-TM, Sevgi-Can-10-K-MF, Cemal-Han-12-M-MF]

        // verilen ismin ogrenciMap'de olup olmadigini kontrol edip
        // true/false dönen bir method olusturun
